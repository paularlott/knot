...
linked_users JSON NOT NULL DEFAULT '[]',
...
refresh_token TINYINT(1) NOT NULL DEFAULT 0,
...
with_vnc TINYINT(1) NOT NULL DEFAULT 0,
...
health_check_auto_restart TINYINT(1) NOT NULL DEFAULT 0,
    ...
    jobs JSON NOT NULL DEFAULT '[]',
    kvm_network_mode VARCHAR(16) NOT NULL DEFAULT '',
    kvm_network_cidr VARCHAR(64) NOT NULL DEFAULT '',
    kvm_ip_range_start VARCHAR(64) NOT NULL DEFAULT '',
    kvm_ip_range_end VARCHAR(64) NOT NULL DEFAULT '',
    kvm_gateway VARCHAR(64) NOT NULL DEFAULT '',
    kvm_bridge VARCHAR(64) NOT NULL DEFAULT '',
    created_user_id CHAR(36),
created_at TIMESTAMP(6),
updated_user_id CHAR(36),
updated_at BIGINT UNSIGNED DEFAULT 0,
