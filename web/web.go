...
func Routes(router *http.ServeMux, cfg *config.ServerConfig) {
	...
	router.HandleFunc("POST /space-io/{space_id}/port/forward", middleware.ApiAuth(HandlePortForward))
	router.HandleFunc("GET /space-io/{space_id}/port/list", middleware.ApiAuth(HandlePortList))
	router.HandleFunc("POST /space-io/{space_id}/port/stop", middleware.ApiAuth(HandlePortStop))
	router.HandleFunc("POST /space-io/{space_id}/port/throttle", middleware.ApiAuth(HandlePortThrottle))
	router.HandleFunc("POST /space-io/{space_id}/port/apply", middleware.ApiAuth(HandlePortApply))
...
func getCommonTemplateData(r *http.Request) (*model.User, map[string]interface{}) {
	...
	data := map[string]interface{}{
		...
		"permissionUsePools":                  user.HasPermission(model.PermissionUsePools),
